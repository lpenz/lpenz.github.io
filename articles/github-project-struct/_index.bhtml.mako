...
<li><a href="#global-practices" id="toc-global-practices"><span
class="toc-section-number">2</span> Global practices</a>
<ul>
<li><a href="#workflow" id="toc-workflow"><span
class="toc-section-number">2.1</span> Workflow</a></li>
<li><a href="#files" id="toc-files"><span
class="toc-section-number">2.2</span> Files</a></li>
<li><a href="#ci" id="toc-ci"><span
class="toc-section-number">2.3</span> CI</a>
<ul>
<li><a href="#provider-github-actions"
id="toc-provider-github-actions"><span
class="toc-section-number">2.3.1</span> Provider: github
actions</a></li>
<li><a href="#test-coverage" id="toc-test-coverage"><span
class="toc-section-number">2.3.2</span> Test coverage</a></li>
<li><a href="#formatter" id="toc-formatter"><span
class="toc-section-number">2.3.3</span> Formatter</a></li>
<li><a href="#omnilint" id="toc-omnilint"><span
class="toc-section-number">2.3.4</span> omnilint</a></li>
<li><a href="#buildtest-matrices" id="toc-buildtest-matrices"><span
class="toc-section-number">2.3.5</span> Build/test matrices</a></li>
</ul></li>
<li><a href="#cd" id="toc-cd"><span
class="toc-section-number">2.4</span> CD</a>
<ul>
<li><a href="#deploy-on-main-or-on-tagging"
id="toc-deploy-on-main-or-on-tagging"><span
class="toc-section-number">2.4.1</span> Deploy on <code>main</code> or
on tagging</a></li>
<li><a href="#debian-on-packagecloud"
id="toc-debian-on-packagecloud"><span
class="toc-section-number">2.4.2</span> Debian on packagecloud</a></li>
<li><a href="#nix" id="toc-nix"><span
class="toc-section-number">2.4.3</span> Nix</a></li>
<li><a href="#project-specific" id="toc-project-specific"><span
class="toc-section-number">2.4.4</span> Project-specific</a></li>
</ul></li>
</ul></li>
<li><a href="#rust" id="toc-rust"><span
class="toc-section-number">3</span> Rust</a></li>
<li><a href="#cc" id="toc-cc"><span class="toc-section-number">4</span>
C/C++</a></li>
<li><a href="#python" id="toc-python"><span
class="toc-section-number">5</span> Python</a></li>
<li><a href="#github-actions" id="toc-github-actions"><span
class="toc-section-number">6</span> github actions</a></li>
<li><a href="#final-remarks" id="toc-final-remarks"><span
class="toc-section-number">7</span> Final remarks</a>
<ul>
<li><a href="#disclaimer" id="toc-disclaimer"><span
class="toc-section-number">7.1</span> Disclaimer</a></li>
</ul></li>
</ul>
</div>
...
<h1 data-number="2" id="global-practices"><span
class="header-section-number">2</span> Global practices</h1>
<p>These are the practices that apply to almost all kinds of
repositories.</p>
<h2 data-number="2.1" id="workflow"><span
class="header-section-number">2.1</span> Workflow</h2>
...
<h2 data-number="2.2" id="files"><span
class="header-section-number">2.2</span> Files</h2>
...
<h2 data-number="2.3" id="ci"><span
class="header-section-number">2.3</span> CI</h2>
<h3 data-number="2.3.1" id="provider-github-actions"><span
class="header-section-number">2.3.1</span> Provider: github actions</h3>
...
<h3 data-number="2.3.2" id="test-coverage"><span
class="header-section-number">2.3.2</span> Test coverage</h3>
...
<h3 data-number="2.3.3" id="formatter"><span
class="header-section-number">2.3.3</span> Formatter</h3>
...
<h3 data-number="2.3.4" id="omnilint"><span
class="header-section-number">2.3.4</span> omnilint</h3>
...
repositories:</p>
<p><code>{yml} jobs:   omnilint:     runs-on: ubuntu-latest     steps:       - uses: actions/checkout@v2       - uses: docker://lpenz/omnilint:v0.2</code></p>
...
<h3 data-number="2.3.5" id="buildtest-matrices"><span
class="header-section-number">2.3.5</span> Build/test matrices</h3>
...
changes.</p>
<h2 data-number="2.4" id="cd"><span
class="header-section-number">2.4</span> CD</h2>
<h3 data-number="2.4.1" id="deploy-on-main-or-on-tagging"><span
class="header-section-number">2.4.1</span> Deploy on <code>main</code>
or on tagging</h3>
...
<p><code>{yml} (...)       - id: version         uses: docker://lpenz/ghaction-version-gen:0.3       - name: deploy         uses: &lt;deploy action&gt;         if: steps.version.outputs.version_commit != ''         with:           version: #dollar#{{ steps.version.outputs.version_commit }}</code></p>
...
<h3 data-number="2.4.2" id="debian-on-packagecloud"><span
class="header-section-number">2.4.2</span> Debian on packagecloud</h3>
...
<h3 data-number="2.4.3" id="nix"><span
class="header-section-number">2.4.3</span> Nix</h3>
<p>TODO</p>
<h3 data-number="2.4.4" id="project-specific"><span
class="header-section-number">2.4.4</span> Project-specific</h3>
...
<h1 data-number="3" id="rust"><span
class="header-section-number">3</span> Rust</h1>
...
<h1 data-number="4" id="cc"><span class="header-section-number">4</span>
C/C++</h1>
...
<h1 data-number="5" id="python"><span
class="header-section-number">5</span> Python</h1>
<p><strong>Example</strong>: <a
...
as a base.</p>
<h1 data-number="6" id="github-actions"><span
class="header-section-number">6</span> github actions</h1>
<p><strong>Example</strong>: <a
...
<h1 data-number="7" id="final-remarks"><span
class="header-section-number">7</span> Final remarks</h1>
...
<h2 data-number="7.1" id="disclaimer"><span
class="header-section-number">7.1</span> Disclaimer</h2>
