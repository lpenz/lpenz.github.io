...
<ul>
<li><a href="#why-pmount" id="toc-why-pmount"><span
class="toc-section-number">1</span> Why pmount</a></li>
<li><a href="#identifying-the-usb-drive"
id="toc-identifying-the-usb-drive"><span
class="toc-section-number">2</span> Identifying the USB drive</a></li>
<li><a href="#creating-the-luks-encrypted-partition"
id="toc-creating-the-luks-encrypted-partition"><span
class="toc-section-number">3</span> Creating the luks-encrypted
partition</a>
<ul>
<li><a href="#partition-the-drive" id="toc-partition-the-drive"><span
class="toc-section-number">3.1</span> Partition the drive</a></li>
<li><a href="#format-the-partition" id="toc-format-the-partition"><span
class="toc-section-number">3.2</span> Format the partition</a></li>
<li><a href="#create-the-filesystem"
id="toc-create-the-filesystem"><span
class="toc-section-number">3.3</span> Create the filesystem</a></li>
</ul></li>
<li><a href="#mountingunmounting-the-drive"
id="toc-mountingunmounting-the-drive"><span
class="toc-section-number">4</span> Mounting/unmounting the
drive</a></li>
<li><a href="#references" id="toc-references"><span
class="toc-section-number">5</span> References</a></li>
</ul>
</div>
