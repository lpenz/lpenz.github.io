...
<li><a href="#top-level" id="toc-top-level"><span
class="toc-section-number">2</span> Top level</a>
<ul>
<li><a href="#top-level-main-function"
id="toc-top-level-main-function"><span
class="toc-section-number">2.1</span> Top-level <code>main</code>
function</a></li>
<li><a href="#tool-specific-main-function"
id="toc-tool-specific-main-function"><span
class="toc-section-number">2.2</span> Tool-specific <code>main</code>
function</a></li>
<li><a href="#crates" id="toc-crates"><span
class="toc-section-number">2.3</span> Crates</a></li>
<li><a href="#async-tool-with-tokio"
id="toc-async-tool-with-tokio"><span
class="toc-section-number">2.4</span> Async tool with tokio</a></li>
</ul></li>
<li><a href="#tests" id="toc-tests"><span
class="toc-section-number">3</span> Tests</a></li>
<li><a href="#errors" id="toc-errors"><span
class="toc-section-number">4</span> Errors</a>
<ul>
<li><a href="#error-type-creation-crateless"
id="toc-error-type-creation-crateless"><span
class="toc-section-number">4.1</span> Error type creation,
crateless</a></li>
<li><a href="#error-type-creation-with-thiserror"
id="toc-error-type-creation-with-thiserror"><span
class="toc-section-number">4.2</span> Error type creation with
<code>thiserror</code></a></li>
<li><a href="#error-handling-with-eyre"
id="toc-error-handling-with-eyre"><span
class="toc-section-number">4.3</span> Error handling with
<code>eyre</code></a></li>
</ul></li>
<li><a href="#traits-for-instantiation"
id="toc-traits-for-instantiation"><span
class="toc-section-number">5</span> Traits for instantiation</a>
<ul>
<li><a href="#default" id="toc-default"><span
class="toc-section-number">5.1</span> Default</a></li>
<li><a href="#from" id="toc-from"><span
class="toc-section-number">5.2</span> From</a></li>
<li><a href="#tryfrom" id="toc-tryfrom"><span
class="toc-section-number">5.3</span> TryFrom</a></li>
</ul></li>
<li><a href="#traits-for-string-conversion"
id="toc-traits-for-string-conversion"><span
class="toc-section-number">6</span> Traits for string conversion</a>
<ul>
<li><a href="#debug" id="toc-debug"><span
class="toc-section-number">6.1</span> Debug</a></li>
<li><a href="#display" id="toc-display"><span
class="toc-section-number">6.2</span> Display</a></li>
<li><a href="#fromstr" id="toc-fromstr"><span
class="toc-section-number">6.3</span> FromStr</a></li>
</ul></li>
<li><a href="#sync-io" id="toc-sync-io"><span
class="toc-section-number">7</span> Sync I/O</a>
<ul>
<li><a href="#running-external-commands"
id="toc-running-external-commands"><span
class="toc-section-number">7.1</span> Running external commands</a></li>
</ul></li>
<li><a href="#async-io-with-tokio" id="toc-async-io-with-tokio"><span
class="toc-section-number">8</span> Async I/O with
<code>tokio</code></a>
<ul>
<li><a href="#running-external-commands-1"
id="toc-running-external-commands-1"><span
class="toc-section-number">8.1</span> Running external commands</a></li>
</ul></li>
<li><a href="#misc-snippets-i.e.-unclassified"
id="toc-misc-snippets-i.e.-unclassified"><span
class="toc-section-number">9</span> Misc snippets
(i.e. unclassified)</a>
<ul>
<li><a href="#entry" id="toc-entry"><span
class="toc-section-number">9.1</span> Entry</a></li>
</ul></li>
</ul>
</div>
...
<h2 data-number="2.1" id="top-level-main-function"><span
class="header-section-number">2.1</span> Top-level <code>main</code>
function</h2>
<p>When creating a tool, we can write a placeholder
<code>src/bin/tool.rs</code> that defines a top-level <code>main</code>
function that just calls a tool-specific <code>main</code> function:</p>
...
<span id="cb1-3"><a href="#cb1-3" aria-hidden="true" tabindex="-1"></a><span class="kw">fn</span> main() <span class="op">-&gt;</span> <span class="dt">Result</span><span class="op">&lt;</span>()<span class="op">,</span> <span class="dt">Box</span><span class="op">&lt;</span><span class="kw">dyn</span> <span class="pp">std::error::</span><span class="bu">Error</span><span class="op">&gt;&gt;</span> <span class="op">{</span></span>
<span id="cb1-4"><a href="#cb1-4" aria-hidden="true" tabindex="-1"></a>    <span class="pp">snippets::</span>main()<span class="op">?;</span></span>
<span id="cb1-5"><a href="#cb1-5" aria-hidden="true" tabindex="-1"></a>    <span class="cn">Ok</span>(())</span>
<span id="cb1-6"><a href="#cb1-6" aria-hidden="true" tabindex="-1"></a><span class="op">}</span></span></code></pre></div>
<h2 data-number="2.2" id="tool-specific-main-function"><span
class="header-section-number">2.2</span> Tool-specific <code>main</code>
function</h2>
<p>The tool-specific <code>main</code> can live somewhere referenced by
<code>lib.rs</code>, or in <code>lib.rs</code> itself. This function
does all initialization, argument parsing, etc. It looks like the
following:</p>
...
<span id="cb2-2"><a href="#cb2-2" aria-hidden="true" tabindex="-1"></a><span class="kw">use</span> <span class="pp">clap::</span>Parser<span class="op">;</span></span>
<span id="cb2-3"><a href="#cb2-3" aria-hidden="true" tabindex="-1"></a><span class="kw">use</span> <span class="pp">color_eyre::</span><span class="dt">Result</span><span class="op">;</span></span>
<span id="cb2-4"><a href="#cb2-4" aria-hidden="true" tabindex="-1"></a></span>
<span id="cb2-5"><a href="#cb2-5" aria-hidden="true" tabindex="-1"></a><span class="kw">use</span> <span class="kw">crate</span><span class="pp">::cli::</span>Cli<span class="op">;</span></span>
<span id="cb2-6"><a href="#cb2-6" aria-hidden="true" tabindex="-1"></a></span>
<span id="cb2-7"><a href="#cb2-7" aria-hidden="true" tabindex="-1"></a><span class="at">#[</span><span class="pp">tracing::</span>instrument<span class="at">]</span></span>
<span id="cb2-8"><a href="#cb2-8" aria-hidden="true" tabindex="-1"></a><span class="kw">pub</span> <span class="kw">fn</span> main() <span class="op">-&gt;</span> <span class="dt">Result</span><span class="op">&lt;</span>()<span class="op">&gt;</span> <span class="op">{</span></span>
<span id="cb2-9"><a href="#cb2-9" aria-hidden="true" tabindex="-1"></a>    <span class="pp">color_eyre::</span>install()<span class="op">?;</span></span>
<span id="cb2-10"><a href="#cb2-10" aria-hidden="true" tabindex="-1"></a>    <span class="pp">tracing_subscriber::</span>fmt()</span>
<span id="cb2-11"><a href="#cb2-11" aria-hidden="true" tabindex="-1"></a>        <span class="op">.</span>with_span_events(<span class="pp">tracing_subscriber::fmt::format::FmtSpan::</span>ACTIVE)</span>
<span id="cb2-12"><a href="#cb2-12" aria-hidden="true" tabindex="-1"></a>        <span class="op">.</span>with_env_filter(<span class="pp">tracing_subscriber::EnvFilter::</span>from_default_env())</span>
<span id="cb2-13"><a href="#cb2-13" aria-hidden="true" tabindex="-1"></a>        <span class="op">.</span>init()<span class="op">;</span></span>
<span id="cb2-14"><a href="#cb2-14" aria-hidden="true" tabindex="-1"></a>    <span class="kw">let</span> args <span class="op">=</span> <span class="pp">Cli::</span>parse()<span class="op">;</span></span>
<span id="cb2-15"><a href="#cb2-15" aria-hidden="true" tabindex="-1"></a>    <span class="co">// Program goes here</span></span>
<span id="cb2-16"><a href="#cb2-16" aria-hidden="true" tabindex="-1"></a>    <span class="co">// Example trace:</span></span>
<span id="cb2-17"><a href="#cb2-17" aria-hidden="true" tabindex="-1"></a>    <span class="pp">tracing::info!</span>(<span class="st">&quot;args struct: {:?}&quot;</span><span class="op">,</span> args)<span class="op">;</span></span>
<span id="cb2-18"><a href="#cb2-18" aria-hidden="true" tabindex="-1"></a>    <span class="co">// Return Ok(()) on success</span></span>
<span id="cb2-19"><a href="#cb2-19" aria-hidden="true" tabindex="-1"></a>    <span class="cn">Ok</span>(())</span>
...
<p>For the functions above to compile, we need some crates:</p>
...
(archived; consider <a
href="https://crates.io/crates/tracing-statistical">tracing-statistical</a>),
maybe with <a
...
infra and not the other way around - meaning that if we modify the setup
above to direct traces to the logging infra, we then effectively set up
a tracing-logging loop.</p>
...
<span id="cb5-3"><a href="#cb5-3" aria-hidden="true" tabindex="-1"></a><span class="at">#[</span><span class="pp">tokio::</span>main<span class="at">]</span></span>
<span id="cb5-4"><a href="#cb5-4" aria-hidden="true" tabindex="-1"></a><span class="kw">async</span> <span class="kw">fn</span> main() <span class="op">-&gt;</span> <span class="dt">Result</span><span class="op">&lt;</span>()<span class="op">,</span> <span class="dt">Box</span><span class="op">&lt;</span><span class="kw">dyn</span> <span class="pp">std::error::</span><span class="bu">Error</span><span class="op">&gt;&gt;</span> <span class="op">{</span></span>
<span id="cb5-5"><a href="#cb5-5" aria-hidden="true" tabindex="-1"></a>    <span class="pp">snippets::</span>main()<span class="op">.</span><span class="kw">await</span><span class="op">?;</span></span>
...
<span id="cb6-2"><a href="#cb6-2" aria-hidden="true" tabindex="-1"></a><span class="kw">use</span> <span class="pp">clap::</span>Parser<span class="op">;</span></span>
<span id="cb6-3"><a href="#cb6-3" aria-hidden="true" tabindex="-1"></a><span class="kw">use</span> <span class="pp">color_eyre::</span><span class="dt">Result</span><span class="op">;</span></span>
<span id="cb6-4"><a href="#cb6-4" aria-hidden="true" tabindex="-1"></a></span>
<span id="cb6-5"><a href="#cb6-5" aria-hidden="true" tabindex="-1"></a><span class="kw">use</span> <span class="kw">crate</span><span class="pp">::cli::</span>Cli<span class="op">;</span></span>
<span id="cb6-6"><a href="#cb6-6" aria-hidden="true" tabindex="-1"></a></span>
<span id="cb6-7"><a href="#cb6-7" aria-hidden="true" tabindex="-1"></a><span class="at">#[</span><span class="pp">tracing::</span>instrument<span class="at">]</span></span>
<span id="cb6-8"><a href="#cb6-8" aria-hidden="true" tabindex="-1"></a><span class="kw">pub</span> <span class="kw">async</span> <span class="kw">fn</span> main() <span class="op">-&gt;</span> <span class="dt">Result</span><span class="op">&lt;</span>()<span class="op">&gt;</span> <span class="op">{</span></span>
<span id="cb6-9"><a href="#cb6-9" aria-hidden="true" tabindex="-1"></a>    <span class="pp">color_eyre::</span>install()<span class="op">?;</span></span>
<span id="cb6-10"><a href="#cb6-10" aria-hidden="true" tabindex="-1"></a>    <span class="pp">tracing_subscriber::</span>fmt()</span>
<span id="cb6-11"><a href="#cb6-11" aria-hidden="true" tabindex="-1"></a>        <span class="op">.</span>with_span_events(<span class="pp">tracing_subscriber::fmt::format::FmtSpan::</span>ACTIVE)</span>
<span id="cb6-12"><a href="#cb6-12" aria-hidden="true" tabindex="-1"></a>        <span class="op">.</span>with_env_filter(<span class="pp">tracing_subscriber::EnvFilter::</span>from_default_env())</span>
<span id="cb6-13"><a href="#cb6-13" aria-hidden="true" tabindex="-1"></a>        <span class="op">.</span>init()<span class="op">;</span></span>
<span id="cb6-14"><a href="#cb6-14" aria-hidden="true" tabindex="-1"></a>    <span class="kw">let</span> args <span class="op">=</span> <span class="pp">Cli::</span>parse()<span class="op">;</span></span>
<span id="cb6-15"><a href="#cb6-15" aria-hidden="true" tabindex="-1"></a>    <span class="co">// Program goes here</span></span>
<span id="cb6-16"><a href="#cb6-16" aria-hidden="true" tabindex="-1"></a>    <span class="co">// Example trace:</span></span>
<span id="cb6-17"><a href="#cb6-17" aria-hidden="true" tabindex="-1"></a>    <span class="pp">tracing::info!</span>(<span class="st">&quot;args struct: {:?}&quot;</span><span class="op">,</span> args)<span class="op">;</span></span>
<span id="cb6-18"><a href="#cb6-18" aria-hidden="true" tabindex="-1"></a>    <span class="co">// Return Ok(()) on success</span></span>
<span id="cb6-19"><a href="#cb6-19" aria-hidden="true" tabindex="-1"></a>    <span class="cn">Ok</span>(())</span>
...
href="https://docs.rs/tracing-subscriber/latest/tracing_subscriber/filter/struct.EnvFilter.html"><code>RUST_LOG</code></a>
environment variable when we use its <code>test</code> macro.
<code>env_logger</code> is a dependency that <code>test-log</code> uses
internally for the environment-based log configuration.</p>
...
class="uri">https://doc.rust-lang.org/book/ch09-02-recoverable-errors-with-result.html</a></li>
</ul>
...
<span id="cb8-7"><a href="#cb8-7" aria-hidden="true" tabindex="-1"></a><span class="kw">pub</span> <span class="kw">enum</span> MyError <span class="op">{</span></span>
